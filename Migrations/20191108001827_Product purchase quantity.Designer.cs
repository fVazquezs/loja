...
namespace loja.Migrations
{
    ...
    [Migration("20191108001827_Product purchase quantity")]
    partial class Productpurchasequantity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("loja.Models.ProductPurchase", b =>
                {
                    ...
                    b.HasAlternateKey("ProductId", "PurchaseId");

                    b.ToTable("ProductPurchase");
                });

            modelBuilder.Entity("loja.Models.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("loja.Models.ProductPurchase", b =>
                {
                    ...
                    b.HasOne("loja.Models.Purchase", "Purchase")
                        .WithMany("Product_Purchase")
